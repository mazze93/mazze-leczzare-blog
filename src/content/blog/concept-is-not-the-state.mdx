...
heroImageAlt: "A classical bust overlaid with an arousal-valence affect-space diagram, emotions plotted as scattered points across grief, panic, ecstasy, and apathy."
readingTime: "~14 min"
...
> **Shareable version:** [an 8-slide carousel (PDF)](/social/concept-is-not-the-state.pdf) distilling the claim, the critique, and the structural safety lesson — built for LinkedIn, sized for anywhere else.

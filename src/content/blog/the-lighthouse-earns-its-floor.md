...
readingTime: "~8 min"
heroImage: "../../assets/images/blog/the-lighthouse-floor-hero.png"
heroImageAlt: "An obsidian shoreline at night — a thin teal beam sweeping from an implied tower of eroded strata, the fractured floor beneath it lit by a single seam of amber."
...
> **Formal companion:** [Intentional Fragility: Accountable Forgetting in Local-First AI](/papers/intentional-fragility.pdf) — the full argument, with the decay model, drift gradient, and earned-floor mechanics made precise.

...
project: decision-telemetry
repoUrl: 'https://github.com/mazze93/claude-code-skills'
artifactNote: 'Ships with a decision-telemetry Claude Code skill and raw session transcript.'
category: "Philosophy"
heroImage: "../../assets/images/blog/alchemical-codex-hero.jpg"
heroImageAlt: "An open alchemical codex, dense with symbolic diagrams, under low amber light."
---
...
<ArtifactEmbed
  src="/artifacts/tree-of-knowledge.html"
  title="The Tree of Knowledge — Qliphoth within Sephiroth"
  height={620}
  caption="Interactive. Select any node to read its decision, then DESCEND (top-right) to surface its Qliphothic shadow and certainty weight."
  fullscreenHref="/artifacts/tree-of-knowledge.html"
/>
